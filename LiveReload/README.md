...
> The standalone [`jeanmarcos-dev/module-livereload`](https://github.com/jeanmarcos-dev/module-livereload) repo is a **read-only mirror** auto-generated by CI on every release — direct commits to it are overwritten.
